...
class _BoardState extends State<Board> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Expanded(child: screens[index]),
      ...
      bottomNavigationBar: NavigationBarTheme(
        ...
        child: NavigationBar(
          ...
          destinations: [
            ...
            NavigationDestination(icon: Icon(Icons.shopping_bag_outlined), label: 'salla'),
            NavigationDestination(icon: Icon(Icons.receipt_outlined), label: 'salla2'),
